...
fun SliderDialog(
    ...
    Dialog(
        onDismissRequest = {
            dynamicScreenViewModel.sliderDialog(false)
        }) {
        ...
        Card(
            ...
            Column(modifier = Modifier
                ...
                Text(
                    text = stringResource(id = R.string.enter_slider_name),
                ...
                OutlinedTextField(
                    ...
                    value = dynamicScreenViewModel.sliderText.value,
                    onValueChange ={
                        dynamicScreenViewModel.sliderText.value = it
                    }
                )
                Spacer(modifier = Modifier.height(16.dp))
                ...
                Row(
                    ...
                    OutlinedButton(
                        ...
                        onClick = {
                            dynamicScreenViewModel.run { sliderDialog(false) }
                        }) {
