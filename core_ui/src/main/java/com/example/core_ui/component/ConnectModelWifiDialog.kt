    ...
    Dialog(
        ...
        Card(
            ...
            Column(
                ...
                Text(
                    text = stringResource(id = R.string.wifi_not_connected_router),
                ...
                Row (modifier = Modifier.fillMaxWidth(),
                    ...
                    OutlinedButton(
                        ...
                        Text(
                            text = stringResource(id = com.example.commonresources.R.string.cancel),
                            fontFamily = interFontFamily,
