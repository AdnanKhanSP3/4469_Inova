...
fun AddItemDialog(
    ...
    Dialog(
        onDismissRequest = {
            adminMainScreenViewModel.dialogState(false)
        }) {
        ...
        Card(
            ...
            Column(modifier = Modifier
                ...
                Text(
                    text = stringResource(id = R.string.enter_page_name),
                ...
                OutlinedTextField(
                    ...
                    value = adminMainScreenViewModel.itemText.value,
                    onValueChange ={
                        adminMainScreenViewModel.itemText.value = it
                    }
                )
                ...
                Row (
                    ...
                    OutlinedButton(
                        ...
                        onClick = {
                            adminMainScreenViewModel.run { dialogState(false) }
                        }) {
