...
fun SliderBtnValueDialog(
    ...
    Dialog(
        onDismissRequest = {
            settingViewModel.sliderBtnValueDialogState(false)
        }
    ){
        ...
        Card(
            ...
            Column (
                ...
                OutlinedTextField(
                    ...
                    value = settingViewModel.updatedSliderBtnValue.toString(),
                    onValueChange ={
                        ...
                        settingViewModel.updatedSliderBtnValue = it.toIntOrNull() ?: 0
