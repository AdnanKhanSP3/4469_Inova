    ...
    Dialog(
        ...
        Card(
            ...
            Column(modifier = Modifier
                ...
                Text(text = stringResource(id = R.string.enter_slider_name),
                ...
                OutlinedTextField(
                    ...
                    value = adminDynamicScreenViewModel.sliderText.value,
                    onValueChange ={
                        adminDynamicScreenViewModel.sliderText.value = it
                    }
                )
                Spacer(modifier = Modifier.height(16.dp))
                ...
                Row(
                    ...
                    OutlinedButton(
                        ...
                        onClick = {
                            adminDynamicScreenViewModel.run { sliderDialog(false) }
                        }) {
                        Text(
